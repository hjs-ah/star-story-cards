...
export default function StoryCard({ story, onEdit, onArchive, onRestore, onRatingChange, onFocus }) {
...
function btnStyle(type) {
  ...
  return {
    ...
    border: isFocus ? "0.5px solid var(--accent-border)" : "0.5px solid var(--border)",
    background: isFocus ? "var(--accent-bg)" : "transparent",
    color: isFocus ? "var(--accent)" : "var(--text2)",
